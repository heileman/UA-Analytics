...
myurl='https://www.onetonline.org/find/result?s=Real%20Estate%20Development%20Analysis&a=1'
    ...
    for ind, i in enumerate(range(n)):
        if ind >0:
            ...
            for link in container.findAll('a', attrs={'href': re.compile("^https://")}):
                ...
                if len(containers3)<1:
                    continue
                elif len(containers3[0].text.split(" "))<4:
                ...
                if p2==[]: AVG=p1
                    ...
                    if '-' in p11[1]: p2=-1*p2
                    AVG=(p1+p2)/2
            Demand=(1+AVG/100)*Wage*Employee/1e8
            #print("CIP: "+ cip)
